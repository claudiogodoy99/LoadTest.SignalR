...
public class CsvWriter {
    ...
    public async Task RegisterTest()
    {
        ...
        await outputFile.WriteLineAsync($"{DateTime.Now.ToString("dd:MM:yyyy hh:mm:ss")} ;{_initializer.Clients} ; {_messageAnalytics.GetTotalMessages()} ; {await _messageAnalytics.GetMessagesPerSecond()} ; {_messageAnalytics.CalculateMediaInterval()} ; {_initializer.Duration} ; {_initializer.Reconnect} ; {_initializer.Comments} ");
    }
